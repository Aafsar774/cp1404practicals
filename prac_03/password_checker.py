...
def is_valid_password(password):
    ...
    for character in password:
        ...
        if character.islower():
            ...
            # Other characters (e.g., spaces or unsupported punctuation) are ignored
            pass

    # Require at least one of each normal type
    if number_of_lower == 0 or number_of_upper == 0 or number_of_digit == 0:
        return False

    # If specials are required, ensure at least one
